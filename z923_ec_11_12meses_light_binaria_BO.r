...
PARAM$experimento <- paste0("EC8232_es200_12meses", ".",LR)
...
PARAM$input$training <- c(201905,201906, 201907, 201908, 201909, 201910, 201911, 201912 202011,202012,202101,202102,202103,202104)
